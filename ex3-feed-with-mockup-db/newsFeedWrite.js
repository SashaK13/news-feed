...
function append1HTMLArticle() {
    var article = document.createElement("article");
    console.log(article);
    document.body.appendChild(article);

    var header = document.createElement("h2");
    header.innerHTML = "This is the title";
    article.appendChild(header);
    console.log(header);

    var paragraph = document.createElement("p");
    paragraph.innerHTML = "This is the paragraph";
...
*
*/
function append100HTMLArticles() {
    ...
    for (var i = 0; i < 100 ; i++) {
      ...
      var header = document.createElement("h2");
      header.innerHTML = "This is the title " + i;
      article.appendChild(header);
      console.log(header);

      var paragraph = document.createElement("p");
      paragraph.innerHTML = "This is the paragraph " + i;
      article.appendChild(paragraph);
      console.log(paragraph);
    }
};
...
/*
* This function shall load all articles from the database,
* and append to the HTML document only the first 20 of the list.
* It shall call the function getArticlesFromServerDatabaseMOCKUP();
*/
function append20ArticlesFromMockupDatabase() {
  ...
  for (var i = 0; i < 20; i++) {
    ...
    var paragraph = document.createElement("p");
    paragraph.innerHTML = articles[i].description;
    article.appendChild(paragraph);
    console.log(paragraph);
